...
- The directory.html file contains a table filled with informaiton and example table data, along with a form where users can input their information to be displayed in the table. Every time the Submit button is pressed, the input text fields are cleared, and the information in the input text fields are appended to a new row under their corresponding headers. Information includes phone number, restaurant, delivery fee, departure time, and name. 
